import { MOVE, PLACEMENT, REACTFORWARDREF, REACTFRAGMENT, REACT_TEXT, CONTEXT, PROVIDER } from "./constants"
...
function updateElement (oldVDom, newVDom) {
  if (oldVDom.type.$$typeof === PROVIDER) {
    updateProvider(oldVDom, newVDom)
  } else if (oldVDom.type.$$typeof === CONTEXT) {
    updateContext(oldVDom, newVDom)
  } else if (oldVDom.type === REACT_TEXT) { // 都是文本
